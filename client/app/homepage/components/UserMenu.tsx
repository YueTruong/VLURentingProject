        ...
        <div className="absolute right-0 mt-3 w-[320px] max-w-[90vw] rounded-2xl bg-white shadow-2xl border border-gray-100 overflow-hidden z-50">
          ...
          <div className="p-2">
            <MenuItem
              ...
              icon={
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s-7-4.35-9.33-8.17C.5 9.5 2.5 6.5 6 6.5c1.9 0 3.2 1 4 2 0.8-1 2.1-2 4-2 3.5 0 5.5 3 3.33 6.33C19 16.65 12 21 12 21z" />
                </svg>
              }
              onClick={() => setIsOpen(false)}
            />
