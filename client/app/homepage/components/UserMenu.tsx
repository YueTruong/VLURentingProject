...
export default function UserMenu({ variant = "default" }: UserMenuProps) {
  ...
  // ?u ti?n l?y full_name, n?u kh?ng c? th? l?y name, cu?i c?ng fallback v? "User"
  ...
  const menuConfig = {
    dashboard: [
      { href: "/profile", label: "Th?ng tin c? nh?n", roles: ["admin", "landlord", "student"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M20 21a8 8 0 10-16 0" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 13a4 4 0 100-8 4 4 0 000 8z" /></svg> },
      { href: "/dashboard", label: "B?ng ?i?u khi?n", roles: ["admin"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 13h8V3H3v10zm10 8h8V11h-8v10zM3 21h8v-6H3v6zm10-10h8V3h-8v8z" /></svg> },
      { href: "/my-posts", label: "Tin c?a t?i", roles: ["landlord", "admin"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h10" /></svg> },
      { href: "/post", label: "??ng tin", roles: ["landlord", "admin"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" /></svg> },
      { href: "/landlord-verification", label: "X?c minh ch? tr?", roles: ["landlord"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3l7 4v6c0 4.418-3 7-7 8-4-1-7-3.582-7-8V7l7-4z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4" /></svg> },
    ],
    utilities: [
      { href: "/favorites", label: "Tin ?? l?u", roles: ["student"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg> },
      { href: "/my-reviews", label: "??nh gi? t? t?i", roles: ["student", "landlord"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" /></svg> },
      { href: "/contracts", label: "H?p ??ng thu?", roles: ["student", "landlord", "admin"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M7 3h7l5 5v13a1 1 0 01-1 1H7a1 1 0 01-1-1V4a1 1 0 011-1z" /><path strokeLinecap="round" strokeLinejoin="round" d="M14 3v5h5" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 13h6" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 17h6" /></svg> },
      { href: "/contract-sign", label: "K? h?p ??ng", roles: ["student", "landlord"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg> },
      { href: "/roommate-management", label: "Qu?n l? ? gh?p", roles: ["student"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M17 20v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 11a4 4 0 100-8 4 4 0 000 8z" /><path strokeLinecap="round" strokeLinejoin="round" d="M23 20v-2a4 4 0 00-3-3.87" /><path strokeLinecap="round" strokeLinejoin="round" d="M16 3.13a4 4 0 010 7.75" /></svg> },
    ],
    others: [
      { href: "/settings", label: "C?i ??t", roles: ["admin", "landlord", "student"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.4 15a1 1 0 00.2 1.1l.1.1a1.25 1.25 0 01-1.77 1.77l-.1-.1a1 1 0 00-1.1-.2 1 1 0 00-.6.9V19a1.25 1.25 0 01-2.5 0v-.2a1 1 0 00-.66-.95 1 1 0 00-1.06.24l-.14.14a1.25 1.25 0 01-1.77-1.77l.14-.14a1 1 0 00.24-1.06 1 1 0 00-.95-.66H5a1.25 1.25 0 010-2.5h.2a1 1 0 00.95-.66 1 1 0 00-.24-1.06l-.14-.14a1.25 1.25 0 011.77-1.77l.14.14a1 1 0 001.06.24A1 1 0 009.5 8.8V8.5a1.25 1.25 0 012.5 0v.2a1 1 0 00.66.95 1 1 0 001.06-.24l.14-.14a1.25 1.25 0 011.77 1.77l-.14.14a1 1 0 00-.24 1.06 1 1 0 00.95.66h.2A1.25 1.25 0 0119.4 15z" /></svg> },
      { href: "/feedback", label: "??ng g?p ? ki?n", roles: ["admin", "student", "landlord"], icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 15a4 4 0 01-4 4H7l-4 3V7a4 4 0 014-4h10a4 4 0 014 4v8z" /></svg> },
    ]
  };
